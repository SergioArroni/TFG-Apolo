...
def close_redis_connection(redis_connection: redis.Redis) -> None:
    """
...
def get_redis_list(redis_connection: redis.Redis, list_name: str) -> list:
    """
    Get a Redis list.
...
def get_redis_list_last_n_elements(redis_connection: redis.Redis, list_name: str, n: int) -> list:
    """
...
def get_redis_list_last_n_elements_and_delete_them(redis_connection: redis.Redis, list_name: str, n: int) -> list:
    """
    ...
    Returns:
        Last N elements of the Redis list.
    """
    elements = get_redis_list_last_n_elements(redis_connection=redis_connection, list_name=list_name, n=n)
    remove_redis_list_last_n_elements(redis_connection=redis_connection, list_name=list_name, n=n)
    return elements


def remove_redis_list_last_n_elements(redis_connection: redis.Redis, list_name: str, n: int) -> None:
    """
...
def remove_redis_list_all_elements(redis_connection: redis.Redis, list_name: str) -> None:
    """
